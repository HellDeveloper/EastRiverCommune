...
namespace Swell.Data
{
    ...
    public static partial class EDataParameter
    {
        ...
        /// <returns></returns>
        public static string GetComparisonOperator(this IDataParameter param)
        {
		...
		public static string GetColumnName(this IDataParameter param)
		{
			int index = param.SourceColumn.IndexOf(Assist.WHITE_SPACE);
			if (index < 0)
				return param.SourceColumn;
			return param.SourceColumn.Substring(0, index).Trim();
		}
        ...
        internal static T Clone<T>(T to, T from) where T : IDataParameter
        {
            ...
            {
                if (to.GetComparisonOperator().EndsWith(" like", StringComparison.OrdinalIgnoreCase))
